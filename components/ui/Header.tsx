...
export default function Header({
  ...
  return (
    <div className="bg-white shadow-md border border-gray-100 rounded-2xl px-6 md:px-10 py-6 flex flex-col md:flex-row justify-between items-center mb-8 gap-4 relative">

      <div className="font-bold text-lg text-brand">
        AIOT
      </div>

      <div className="md:absolute md:left-1/2 md:-translate-x-1/2 font-black text-xl md:text-2xl tracking-tight text-gray-800 whitespace-nowrap">
        CodePool-i Study
      </div>
